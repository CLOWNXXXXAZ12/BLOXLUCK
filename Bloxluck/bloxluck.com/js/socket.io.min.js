    ...
    return r = [function(t, e, n) {
        function r(t, e) {
            ...
            var t = i(t),
                ...
                o = t.path,
                o = c[r] && o in c[r].nsps,
                o = e.forceNew || e["force new connection"] || !1 === e.multiplex || o ? (a("ignoring socket cache for %s", n), s(n, e)) : (c[r] || (a("new io instance for %s", n), c[r] = s(n, e)), c[r]);
            return t.query && !e.query && (e.query = t.query), o.socket(t.path, e)
        }
        var i = n(1),
            o = n(7),
            s = n(12),
        ...
        e.protocol = o.protocol, e.connect = r, e.Manager = n(12), e.Socket = n(37)
    }, function(t, e, n) {
        var r = n(2),
            o = n(3)("socket.io-client:url");
        t.exports = function(t, e) {
            var n = t;
            return e = e || "undefined" != typeof location && location, "string" == typeof(t = null == t ? e.protocol + "//" + e.host : t) && ("/" === t.charAt(0) && (t = "/" === t.charAt(1) ? e.protocol + t : e.host + t), /^(https?|wss?):\/\//.test(t) || (o("protocol-less url %s", t), t = void 0 !== e ? e.protocol + "//" + t : "https://" + t), o("parse %s", t), n = r(t)), n.port || (/^(http|ws)$/.test(n.protocol) ? n.port = "80" : /^(http|ws)s$/.test(n.protocol) && (n.port = "443")), n.path = n.path || "/", t = -1 !== n.host.indexOf(":") ? "[" + n.host + "]" : n.host, n.id = n.protocol + "://" + t + ":" + n.port, n.href = n.protocol + "://" + t + (e && e.port === n.port ? "" : ":" + n.port), n
        }
    }, function(t, e) {
        ...
        t.exports = function(t) {
            ...
            for (var o, i = c.exec(t || ""), s = {}, a = 14; a--;) s[p[a]] = i[a] || "";
            return -1 != n && -1 != r && (s.source = e, s.host = s.host.substring(1, s.host.length - 1).replace(/;/g, ":"), s.authority = s.authority.replace("[", "").replace("]", "").replace(/;/g, ":"), s.ipv6uri = !0), s.pathNames = (t = s.path, n = t.replace(/\/{2,9}/g, "/").split("/"), "/" != t.substr(0, 1) && 0 !== t.length || n.splice(0, 1), "/" == t.substr(t.length - 1, 1) && n.splice(n.length - 1, 1), n), s.queryKey = (r = s.query, o = {}, r.replace(/(?:^|&)([^&=]*)=?([^&]*)/g, function(t, e, n) {
                e && (o[e] = n)
            }), o), s
        }
    }, function(r, o, i) {
        ! function(e) {
            ...
            (o = r.exports = i(5)).log = function() {
                ...
                t[0] = (r ? "%c" : "") + this.namespace + (r ? " %c" : " ") + t[0] + (r ? "%c " : " ") + "+" + o.humanize(this.diff), r && (r = "color: " + this.color, t.splice(1, 0, r, "color: inherit"), t[n = e = 0].replace(/%[a-zA-Z%]/g, function(t) {
                    "%%" !== t && (e++, "%c" === t && (n = e))
                }), t.splice(n, 0, r))
            }, o.save = function(t) {
                try {
        ...
        function i() {
            l && u && (l = !1, u.length ? f = u.concat(f) : d = -1, f.length && s())
        }
            ...
            if (!l) {
                ...
                u = null, l = !1,
                    function(e) {
                        ...
                        if ((h === r || !h) && clearTimeout) return (h = clearTimeout)(e);
                        try {
                            h(e)
                        } catch (t) {
                            try {
        ...
        function n(t) {
            function s() {
                if (s.enabled) {
                    ...
                    o[0] = c.coerce(o[0]), "string" != typeof o[0] && o.unshift("%O");
                    var i = 0;
                    o[0] = o[0].replace(/%([a-zA-Z%])/g, function(t, e) {
                        if ("%%" === t) return t;
                        i++;
                        var n, e = c.formatters[e];
                        return "function" == typeof e && (n = o[i], t = e.call(r, n), o.splice(i, 1), i--), t
                    }), c.formatArgs.call(r, o), (s.log || c.log || console.log.bind(console)).apply(r, o)
                }
            }
            var a;
            return s.namespace = t, s.enabled = c.enabled(t), s.useColors = c.useColors(), s.color = function(t) {
                var e, n = 0;
                for (e in t) n = (n << 5) - n + t.charCodeAt(e), n |= 0;
                return c.colors[Math.abs(n) % c.colors.length]
            }(t), s.destroy = r, "function" == typeof c.init && c.init(s), c.instances.push(s), s
        }
        ...
        function r() {
            ...
            for (var e = ("string" == typeof t ? t : "").split(/[\s,]+/), n = e.length, r = 0; r < n; r++) e[r] && ("-" === (t = e[r].replace(/\*/g, ".*?"))[0] ? c.skips.push(new RegExp("^" + t.substr(1) + "$")) : c.names.push(new RegExp("^" + t + "$")));
            ...
            return !1
        }, c.humanize = e(6), c.instances = [], c.names = [], c.skips = [], c.formatters = {}
    }, function(t, e) {
        function o(t, e, n) {
        ...
        t.exports = function(t, e) {
            ...
            if (!("string" == n && 0 < t.length)) {
                if ("number" == n && !1 === isNaN(t)) return e.long ? o(n = t, s, "day") || o(n, i, "hour") || o(n, 6e4, "minute") || o(n, 1e3, "second") || n + " ms" : s <= (e = t) ? Math.round(e / s) + "d" : i <= e ? Math.round(e / i) + "h" : 6e4 <= e ? Math.round(e / 6e4) + "m" : 1e3 <= e ? Math.round(e / 1e3) + "s" : e + "ms";
        ...
        function r(t) {
            var e = "" + t.type;
            if (s.BINARY_EVENT !== t.type && s.BINARY_ACK !== t.type || (e += t.attachments + "-"), t.nsp && "/" !== t.nsp && (e += t.nsp + ","), null != t.id && (e += t.id), null != t.data) {
                var n = function(t) {
                    try {
                        return JSON.stringify(t)
                    } catch (t) {
        ...
        function a(t) {
            ...
            if (null == s.types[n.type]) return p("unknown packet type " + n.type);
            ...
            if (t.charAt(++e)) {
                ...
                if (!(!1 !== i && (n.type === s.ERROR || l(i)))) return p("invalid payload");
                n.data = i
            }
        ...
        var h = e(3)("socket.io-parser"),
            ...
            l = e(10),
            d = e(11),
            y = (s.protocol = 4, s.types = ["CONNECT", "DISCONNECT", "EVENT", "ACK", "ERROR", "BINARY_EVENT", "BINARY_ACK"], s.CONNECT = 0, s.DISCONNECT = 1, s.EVENT = 2, s.ACK = 3, s.ERROR = 4, s.BINARY_EVENT = 5, s.BINARY_ACK = 6, s.Encoder = n, s.Decoder = i, s.ERROR + '"encode error"');
        n.prototype.encode = function(t, e) {
            h("encoding packet %j", t), s.BINARY_EVENT === t.type || s.BINARY_ACK === t.type ? o(t, e) : e([r(t)])
        }, u(i.prototype), i.prototype.add = function(t) {
            var e;
            if ("string" == typeof t) e = a(t), s.BINARY_EVENT === e.type || s.BINARY_ACK === e.type ? (this.reconstructor = new c(e), 0 === this.reconstructor.reconPack.attachments && this.emit("decoded", e)) : this.emit("decoded", e);
            else {
            ...
            return this.buffers.push(t), this.buffers.length === this.reconPack.attachments ? (t = f.reconstructPacket(this.reconPack, this.buffers), this.finishedReconstruction(), t) : null
        ...
        function r(t, e) {
            ...
            t = e.parser || s;
            this.encoder = new t.Encoder, this.decoder = new t.Decoder, this.autoConnect = !1 !== e.autoConnect, this.autoConnect && this.open()
        }
        var c = n(13),
            i = n(37),
            o = n(8),
        ...
        (t.exports = r).prototype.emitAll = function() {
        ...
        }, o(r.prototype), r.prototype.reconnection = function(t) {
            ...
            var e, r, o = this.engine,
                i = this,
                s = (this.readyState = "opening", this.skipReconnect = !1, p(o, "open", function() {
                    i.onopen(), n && n()
                })),
                a = p(o, "error", function(t) {
                    var e;
                    h("connect_error"), i.cleanup(), i.readyState = "closed", i.emitAll("connect_error", t), n ? ((e = new Error("Connection error")).data = t, n(e)) : i.maybeReconnectOnOpen()
                });
            return !1 !== this._timeout && (e = this._timeout, h("connect attempt will timeout after %d", e), 0 === e && s.destroy(), r = setTimeout(function() {
                h("connect attempt timed out after %d", e), s.destroy(), o.close(), o.emit("error", "timeout"), i.emitAll("connect_timeout", e)
            }, e), this.subs.push({
                destroy: function() {
                    clearTimeout(r)
                }
            ...
            var t = this.engine;
            this.subs.push(p(t, "data", a(this, "ondata"))), this.subs.push(p(t, "ping", a(this, "onping"))), this.subs.push(p(t, "pong", a(this, "onpong"))), this.subs.push(p(t, "error", a(this, "onerror"))), this.subs.push(p(t, "close", a(this, "onclose"))), this.subs.push(p(this.decoder, "decoded", a(this, "ondecoded")))
            ...
            var r, o = this.nsps[t];
            return o || (o = new i(this, t, e), this.nsps[t] = o, r = this, o.on("connecting", n), o.on("connect", function() {
                o.id = r.generateId(t)
            }), this.autoConnect && n()), o
        ...
        function u(t, e) {
            return this instanceof u ? (e = e || {}, t && "object" == typeof t && (e = t, t = null), t ? (t = a(t), e.hostname = t.host, e.secure = "https" === t.protocol || "wss" === t.protocol, e.port = t.port, t.query && (e.query = t.query)) : e.host && (e.hostname = a(e.host).host), this.secure = null != e.secure ? e.secure : "undefined" != typeof location && "https:" === location.protocol, e.hostname && !e.port && (e.port = this.secure ? "443" : "80"), this.agent = e.agent || !1, this.hostname = e.hostname || ("undefined" != typeof location ? location.hostname : "localhost"), this.port = e.port || ("undefined" != typeof location && location.port ? location.port : this.secure ? 443 : 80), this.query = e.query || {}, "string" == typeof this.query && (this.query = c.decode(this.query)), this.upgrade = !1 !== e.upgrade, this.path = (e.path || "/engine.io").replace(/\/$/, "") + "/", this.forceJSONP = !!e.forceJSONP, this.jsonp = !1 !== e.jsonp, this.forceBase64 = !!e.forceBase64, this.enablesXDR = !!e.enablesXDR, this.withCredentials = !1 !== e.withCredentials, this.timestampParam = e.timestampParam || "t", this.timestampRequests = e.timestampRequests, this.transports = e.transports || ["polling", "websocket"], this.transportOptions = e.transportOptions || {}, this.readyState = "", this.writeBuffer = [], this.prevBufferLen = 0, this.policyPort = e.policyPort || 843, this.rememberUpgrade = e.rememberUpgrade || !1, this.binaryType = null, this.onlyBinaryUpgrades = e.onlyBinaryUpgrades, this.perMessageDeflate = !1 !== e.perMessageDeflate && (e.perMessageDeflate || {}), !0 === this.perMessageDeflate && (this.perMessageDeflate = {}), this.perMessageDeflate && null == this.perMessageDeflate.threshold && (this.perMessageDeflate.threshold = 1024), this.pfx = e.pfx || null, this.key = e.key || null, this.passphrase = e.passphrase || null, this.cert = e.cert || null, this.ca = e.ca || null, this.ciphers = e.ciphers || null, this.rejectUnauthorized = void 0 === e.rejectUnauthorized || e.rejectUnauthorized, this.forceNode = !!e.forceNode, this.isReactNative = "undefined" != typeof navigator && "string" == typeof navigator.product && "reactnative" === navigator.product.toLowerCase(), "undefined" != typeof self && !this.isReactNative || (e.extraHeaders && 0 < Object.keys(e.extraHeaders).length && (this.extraHeaders = e.extraHeaders), e.localAddress && (this.localAddress = e.localAddress)), this.id = null, this.upgrades = null, this.pingInterval = null, this.pingTimeout = null, this.pingIntervalTimer = null, this.pingTimeoutTimer = null, void this.open()) : new u(t, e)
        }
        var r = n(15),
            o = n(8),
            ...
            a = n(2),
            c = n(30);
        (t.exports = u).priorWebsocketSuccess = !1, o(u.prototype), u.protocol = s.protocol, (u.Socket = u).Transport = n(21), u.transports = n(15), u.parser = n(22), u.prototype.createTransport = function(t) {
            ...
            var e = function(t) {
                ...
                n = (e.EIO = s.protocol, e.transport = t, this.transportOptions[t] || {});
            ...
            var t, e;
            if (this.rememberUpgrade && u.priorWebsocketSuccess && -1 !== this.transports.indexOf("websocket")) t = "websocket";
            else {
            ...
            var e = this;
            this.transport && (f("clearing existing transport %s", this.transport.name), this.transport.removeAllListeners()), (this.transport = t).on("drain", function() {
                e.onDrain()
            ...
            function t() {
                var t;
                h.onlyBinaryUpgrades && (t = !this.supportsBinary && h.transport.supportsBinary, p = p || t), p || (f('probe transport "%s" opened', n), c.send([{
                    type: "ping",
                    data: "probe"
                }]), c.once("packet", function(t) {
                    p || ("pong" === t.type && "probe" === t.data ? (f('probe transport "%s" pong', n), h.upgrading = !0, h.emit("upgrading", c), c && (u.priorWebsocketSuccess = "websocket" === c.name, f('pausing current transport "%s"', h.transport.name), h.transport.pause(function() {
                        p || "closed" !== h.readyState && (f("changing transport and sending upgrade packet"), a(), h.setTransport(c), c.send([{
                            type: "upgrade"
                        }]), h.emit("upgrade", c), c = null, h.upgrading = !1, h.flush())
                    }))) : (f('probe transport "%s" failed', n), (t = new Error("probe error")).transport = c.name, h.emit("upgradeError", t)))
                }))
            }
            ...
            function e(t) {
                ...
                e.transport = c.name, r(), f('probe transport "%s" failed because of error: %s', n, t), h.emit("upgradeError", e)
            }
            ...
            var c = this.createTransport(n, {
                ...
                p = !1,
                h = this;
            u.priorWebsocketSuccess = !1, c.once("open", t), c.once("error", e), c.once("close", o), this.once("close", i), this.once("upgrading", s), c.open()
            ...
            if ("opening" === this.readyState || "open" === this.readyState || "closing" === this.readyState) switch (f('socket receive: type "%s", data "%s"', t.type, t.data), this.emit("packet", t), this.emit("heartbeat"), t.type) {
                case "open":
            ...
            "function" == typeof e && (r = e, e = void 0), "function" == typeof n && (r = n, n = null), "closing" !== this.readyState && "closed" !== this.readyState && ((n = n || {}).compress = !1 !== n.compress, this.emit("packetCreate", t = {
                type: t,
                data: e,
                options: n
            }), this.writeBuffer.push(t), r && this.once("flush", r), this.flush())
            ...
            var r;
            return "opening" !== this.readyState && "open" !== this.readyState || (this.readyState = "closing", (r = this).writeBuffer.length ? this.once("drain", function() {
                (this.upgrading ? n : t)()
        ...
        e.polling = function(t) {
            var e, n, r = !1,
                o = !1,
                i = !1 !== t.jsonp;
            if ("undefined" != typeof location && (e = "https:" === location.protocol, n = (n = location.port) || (e ? 443 : 80), r = t.hostname !== location.hostname || n !== t.port, o = t.secure !== e), t.xdomain = r, t.xscheme = o, "open" in new s(t) && !t.forceJSONP) return new a(t);
            if (i) return new c(t);
        ...
        function o(t) {
            var e, n;
            c.call(this, t), this.requestTimeout = t.requestTimeout, this.extraHeaders = t.extraHeaders, "undefined" != typeof location && (e = "https:" === location.protocol, n = (n = location.port) || (e ? 443 : 80), this.xd = "undefined" != typeof location && t.hostname !== location.hostname || n !== t.port, this.xs = t.secure !== e)
        }
        ...
        t.exports = o, t.exports.Request = i, h(o, c), o.prototype.supportsBinary = !0, o.prototype.request = function(t) {
            ...
            var t = {
                ...
                e = (t.pfx = this.pfx, t.key = this.key, t.passphrase = this.passphrase, t.cert = this.cert, t.ca = this.ca, t.ciphers = this.ciphers, t.rejectUnauthorized = this.rejectUnauthorized, this.xhr = new a(t)),
                n = this;
            try {
            ...
            this.cleanup()
        }, i.requestsCount = 0, i.requests = {}, "undefined" != typeof document && ("function" == typeof attachEvent ? attachEvent("onunload", s) : "function" == typeof addEventListener && (t = "onpagehide" in n ? "pagehide" : "unload", addEventListener(t, s, !1)))
    }, function(t, e, n) {
        function r(t) {
        ...
        a(r, o), r.prototype.name = "polling", r.prototype.doOpen = function() {
            ...
            var n, r = this;
            this.readyState = "pausing", this.polling || !this.writable ? (n = 0, this.polling && (p("we are currently polling - waiting to pause"), n++, this.once("pollComplete", function() {
            ...
            s.decodePayload(t, this.socket.binaryType, function(t, e, n) {
                return "opening" === r.readyState && "open" === t.type && r.onOpen(), "close" === t.type ? (r.onClose(), !1) : void r.onPacket(t)
        ...
        function u(t, e, n) {
            if (!e) return f.encodeBase64Packet(t, n); {
                ...
                return (e = new Uint8Array(1))[0] = y[t.type], n(new m([e.buffer, t.data]))
            }
        }

        function i(t, e, n) {
            for (var o = new Array(t.length), r = a(t.length, n), i = 0; i < t.length; i++) ! function(n, t, r) {
                e(t, function(t, e) {
                    o[n] = e, r(t, o)
                })
            }(i, t[i], r)
        ...
        var r, n = e(23),
            ...
            a = e(26),
            d = e(27),
            o = ("undefined" != typeof ArrayBuffer && (r = e(28)), "undefined" != typeof navigator && /Android/i.test(navigator.userAgent)),
            c = "undefined" != typeof navigator && /PhantomJS/i.test(navigator.userAgent),
            p = o || c,
            y = (f.protocol = 3, f.packets = {
                open: 0,
                close: 1,
                ping: 2,
                pong: 3,
        ...
        f.encodePacket = function(t, e, n, r) {
            ...
            if (void 0 !== m && e.data instanceof m) return (r = new FileReader).onload = function() {
            ...
            for (var r, o, i = "", s = 0, a = t.length; s < a; s++) {
                ...
                if (":" === c) {
                    ...
                    if (o.length) {
                        if (o = f.decodePacket(o, e, !1), g.type === o.type && g.data === o.data) return n(g, 0, 1);
            ...
            return t.length ? void i(t, function(t, e) {
                ...
                return e.forEach(function(t) {
                    ...
                    s[a++] = e ? 0 : 1;
                    for (var i = n.byteLength.toString(), o = 0; o < i.length; o++) s[a++] = parseInt(i[o]);
                    s[a++] = 255;
            ...
            i(t, function(t, s) {
                f.encodePacket(t, !0, !0, function(t) {
                    ...
                    for (var o = (t instanceof ArrayBuffer ? t.byteLength : t.size).toString(), i = new Uint8Array(o.length + 1), r = 0; r < o.length; r++) i[r] = parseInt(o[r]);
                    i[o.length] = 255, m && (e = new m([e.buffer, i.buffer, t]), s(null, e))
                })
            }, function(t, e) {
                return n(new m(e))
            })
            ...
            for (var e = t, o = []; 0 < e.byteLength;) {
                ...
                if (s) try {
                    ...
                    for (var h = new Uint8Array(p), p = "", c = 0; c < h.length; c++) p += String.fromCharCode(h[c])
                }
                o.push(p), e = l(e, a)
            }
            var u = o.length;
        ...
        t.exports = {
            version: "2.1.2",
            encode: function(t, e) {
                for (var n = !1 !== (e = e || {}).strict, r = h(t), o = r.length, i = -1, s = ""; ++i < o;) s += function(t, e) {
                    if (0 == (4294967168 & t)) return g(t);
                    var n = "";
                    return 0 == (4294965248 & t) ? n = g(t >> 6 & 31 | 192) : 0 == (4294901760 & t) ? (u(t, e) || (t = 65533), n = g(t >> 12 & 15 | 224), n += a(t, 6)) : 0 == (4292870144 & t) && (n = g(t >> 18 & 7 | 240), n = (n += a(t, 12)) + a(t, 6)), n + g(63 & t | 128)
                }(r[i], n);
                return s
            },
            decode: function(t, e) {
                ...
                for (var r, o = []; !1 !== (r = function(t) {
                        ...
                        if (224 == (240 & e)) {
                            if (2048 <= (n = (15 & e) << 12 | f() << 6 | f())) return u(n, t) ? n : 65533;
                            throw Error("Invalid continuation byte")
                        }
                        if (240 == (248 & e) && (65536 <= (n = (7 & e) << 18 | f() << 12 | f() << 6 | f()) && n <= 1114111)) return n;
                        throw Error("Invalid UTF-8 detected")
                    }(n));) o.push(r);
                for (var i, s = o, a = s.length, c = -1, p = ""; ++c < a;) 65535 < (i = s[c]) && (p += g((i -= 65536) >>> 10 & 1023 | 55296), i = 56320 | 1023 & i), p += g(i);
                return p
            }
        }
    }, function(t, e) {
        ! function(h) {
            "use strict";
            e.encode = function(t) {
                for (var e = new Uint8Array(t), n = e.length, r = "", o = 0; o < n; o += 3) r = (r = (r = (r += h[e[o] >> 2]) + h[(3 & e[o]) << 4 | e[o + 1] >> 4]) + h[(15 & e[o + 1]) << 2 | e[o + 2] >> 6]) + h[63 & e[o + 2]];
                return n % 3 == 2 ? r = r.substring(0, r.length - 1) + "=" : n % 3 == 1 && (r = r.substring(0, r.length - 2) + "=="), r
            }, e.decode = function(t) {
                for (var e, n, r, o, i = .75 * t.length, s = t.length, a = 0, i = ("=" === t[t.length - 1] && (i--, "=" === t[t.length - 2] && i--), new ArrayBuffer(i)), c = new Uint8Array(i), p = 0; p < s; p += 4) e = h.indexOf(t[p]), n = h.indexOf(t[p + 1]), r = h.indexOf(t[p + 2]), o = h.indexOf(t[p + 3]), c[a++] = e << 2 | n >> 4, c[a++] = (15 & n) << 4 | r >> 2, c[a++] = (3 & r) << 6 | 63 & o;
                return i
            }
        ...
        function r(t) {
            return t.map(function(t) {
                var e, n;
                return t.buffer instanceof ArrayBuffer ? (e = t.buffer, t.byteLength !== e.byteLength && ((n = new Uint8Array(t.byteLength)).set(new Uint8Array(e, t.byteOffset, t.byteLength)), e = n.buffer), e) : t
            })
        }
        ...
        "undefined" != typeof Blob && (n.prototype = Blob.prototype, o.prototype = Blob.prototype), t.exports = s ? a ? Blob : o : c ? n : void 0
    }, function(t, e) {
        e.encode = function(t) {
            var e, n = "";
        ...
        s(o, i), o.prototype.supportsBinary = !1, o.prototype.doClose = function() {
            ...
            var e = this,
                ...
                n = (this.script && (this.script.parentNode.removeChild(this.script), this.script = null), t.async = !0, t.src = this.uri(), t.onerror = function(t) {
        ...
        var f = o || i;
        p(t.exports = r, s), r.prototype.name = "websocket", r.prototype.supportsBinary = !0, r.prototype.doOpen = function() {
            if (this.check()) {
                var t = this.uri(),
                    e = this.protocols,
                    n = {};
            ...
            for (var o = t.length, e = 0, n = o; e < n; e++) ! function(n) {
                a.encodePacket(n, r.supportsBinary, function(t) {
                    var e;
                    r.usingBrowserWebSocket || (e = {}, n.options && (e.compress = n.options.compress), r.perMessageDeflate && ("string" == typeof t ? Buffer.byteLength(t) : t.length) < r.perMessageDeflate.threshold && (e.compress = !1));
                    try {
        ...
        function r(t, e, n) {
            this.io = t, this.nsp = e, (this.json = this).ids = 0, this.acks = {}, this.receiveBuffer = [], this.sendBuffer = [], this.connected = !1, this.disconnected = !0, this.flags = {}, n && n.query && (this.query = n.query), this.io.autoConnect && this.open()
        }
        var o = n(7),
            i = n(8),
            s = n(38),
        ...
        i(r.prototype), r.prototype.subEvents = function() {
            var t;
            this.subs || (t = this.io, this.subs = [a(t, "open", c(this, "onopen")), a(t, "packet", c(this, "onpacket")), a(t, "close", c(this, "onclose"))])
            ...
            return n.options.compress = !this.flags || !1 !== this.flags.compress, "function" == typeof e[e.length - 1] && (p("emitting packet with ack id %d", this.ids), this.acks[this.ids] = e.pop(), n.id = this.ids++), this.connected ? this.packet(n) : this.sendBuffer.push(n), this.flags = {}, this
        }, r.prototype.packet = function(t) {
            t.nsp = this.nsp, this.io.packet(t)
        }, r.prototype.onopen = function() {
            var t;
            p("transport is open - connecting"), "/" !== this.nsp && (this.query ? (t = "object" == typeof this.query ? h.encode(this.query) : this.query, p("sending connect packet with query %s", t), this.packet({
                type: o.CONNECT,
                query: t
            })) : this.packet({
                type: o.CONNECT
            ...
            return function() {
                var t;
                r || (r = !0, t = s(arguments), p("sending ack %j", t), n.packet({
